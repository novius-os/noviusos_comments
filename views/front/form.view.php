...
?>
        <table border="0">
            ...
            <tr>
                ...
                <td><input type="text" style="width:300px;" maxlength="100" id="comm_email" name="comm_email" value="<?= \Nos\FrontCache::viewForgeUncached('noviusos_comments::front/email') ?>"></td>
            </tr>
            <tr>
